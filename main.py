...
def load_users():
    ...
    default = {"LOUAY": {"password": "LOUAY1233", "role": "admin"}}
    save_users(default)
    return default
...
if 'LOUAY' not in data:
    data['LOUAY'] = {"password": "LOUAY1233", "role": "admin"}
    save_users(data)
...
def api_create_server():
    ...
    if not username:
        username = f"C4X_CODEX{random.randint(10000, 99999)}"
